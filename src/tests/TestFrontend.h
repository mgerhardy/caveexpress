...
public:
	TestFrontend (int width = 1024, int height = 768) { _height = height; _width = width; }
	...
	void renderLineWithTexture (int x1, int y1, int x2, int y2, Texture* texture) {}
	...
	bool handlesInput () const override { return false; }
	int init (int width, int height, bool fullscreen, EventHandler &eventHandler) override { return 1; }
