...
UIRoundResultWindow::UIRoundResultWindow(IFrontend *frontend,
		...
		UIWindow("roundresult", frontend, WINDOW_FLAG_MODAL), _gameRound(gameRound) {
	...
	_totalScore->setStandardPadding();
	...
	_totalTopScore->setStandardPadding();
	...
	labelTopScore->setStandardPadding();
	...
	viewResults->setStandardPadding();
	...
	shareResults->setStandardPadding();
