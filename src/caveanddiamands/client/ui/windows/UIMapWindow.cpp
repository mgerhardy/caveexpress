...
#include "caveanddiamonds/client/ui/nodes/UINodeMap.h"
#include "caveanddiamonds/client/ui/nodes/UICaveAndDiamondsNodePoint.h"
...
void UIMapWindow::initHudNodes ()
{
	...
	_points = new UICaveAndDiamondsNodePoint(_frontend, 30);
