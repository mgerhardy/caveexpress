#include "UICaveAndDiamondsMapOptionsWindow.h"
...
UICaveAndDiamondsMapOptionsWindow::UICaveAndDiamondsMapOptionsWindow (IFrontend *frontend, ServiceProvider& serviceProvider) :
...
void UICaveAndDiamondsMapOptionsWindow::onActive ()
{
