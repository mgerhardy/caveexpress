...
void MapContext::onMapLoaded() {
}

bool MapContext::isEmpty(int col, int row) const {
	if (row < 0)
		return false;
...
bool MapContext::load(bool skipErrors) {
...
void MapContext::addTile(const std::string& tile, int col, int row) {
...
inline void MapContext::addTarget(int col, int row) {
	addTile("target", col, row);
}

inline void MapContext::addWall(int col, int row) {
...
inline void MapContext::addGround(int col, int row) {
