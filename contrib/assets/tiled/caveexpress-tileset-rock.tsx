...
<tileset version="1.8" tiledversion="1.8.2" name="caveexpress-tileset-rock" tilewidth="1024" tileheight="1024" tilecount="47" columns="0">
 ...
 <tile id = "1">
  <image width = "1" height = "1" source = "../png/caveexpress/bridge-wall-left-01-front-01.png" />
  <objectgroup draworder="index" id="2">
   <object id="1" x="0" y="0" width="1" height="1">
    <polygon points="0,0 0,0 0,0 0,0 "/>
   </object>
 ...
 <tile id = "2">
  <image width = "1" height = "1" source = "../png/caveexpress/bridge-wall-right-01-front-01.png" />
  <objectgroup draworder="index" id="2">
   <object id="1" x="0" y="0" width="1" height="1">
    <polygon points="0,0 0,0 0,0 0,0 "/>
   </object>
 ...
 <tile id = "3">
  <image width = "1" height = "1" source = "../png/caveexpress/item-package-idle-middle-01.png" />
 </tile>
 <tile id = "4">
  <image width = "0" height = "2" source = "../png/caveexpress/liane-01-front-01.png" />
 </tile>
 <tile id = "5">
  <image width = "1" height = "1" source = "../png/caveexpress/tile-background-01-back-01.png" />
 </tile>
 <tile id = "6">
  <image width = "1" height = "1" source = "../png/caveexpress/tile-background-02-back-01.png" />
 </tile>
 <tile id = "7">
  <image width = "1" height = "1" source = "../png/caveexpress/tile-background-03-back-01.png" />
 </tile>
 <tile id = "8">
  <image width = "1" height = "1" source = "../png/caveexpress/tile-background-04-back-01.png" />
 </tile>
 <tile id = "9">
  <image width = "2" height = "2" source = "../png/caveexpress/tile-background-big-01-back-01.png" />
 </tile>
 <tile id = "10">
  <image width = "1" height = "1" source = "../png/caveexpress/tile-background-cave-art-01-back-01.png" />
 </tile>
 <tile id = "11">
  <image width = "1" height = "1" source = "../png/caveexpress/tile-background-window-01-on.png" />
 </tile>
 <tile id = "12">
  <image width = "1" height = "1" source = "../png/caveexpress/tile-background-window-02-on.png" />
 </tile>
 <tile id = "13">
  <image width = "1" height = "1" source = "../png/caveexpress/tile-cave-01-on.png" />
 </tile>
 <tile id = "14">
