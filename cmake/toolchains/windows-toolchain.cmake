...
if (MSYS)
	...
	set(CMAKE_C_FLAGS_DEBUG "/Zi /Od /Oy- /MTd /D__FLTUSED__ /D_DEBUG /DDEBUG=1")
	set(CMAKE_C_FLAGS_RELEASE "/Ox /MT /DNDEBUG /D__FLTUSED__")

	set(CMAKE_CXX_FLAGS "/EHsc /MP /WX /TP /DWIN32")
	set(CMAKE_CXX_FLAGS_DEBUG "/Zi /Od /Oy- /MTd /D__FLTUSED__ /D_DEBUG /DDEBUG=1")
	set(CMAKE_CXX_FLAGS_RELEASE "/Ox /MT /D__FLTUSED__ /DNDEBUG")
