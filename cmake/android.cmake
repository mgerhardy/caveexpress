...
if (NOT ANDROID_DEBUG_KEYSTORE)
	...
	if (KEYTOOL)
		message(STATUS "keytool found - generate debug keystore")
		execute_process(COMMAND ${KEYTOOL} -genkey ${KEYTOOL_FLAGS} -keystore $ENV{HOME}/.android/debug.keystore -storepass ${ANDROID_DEBUG_STOREPASS} -alias ${ANDROID_DEBUG_ALIAS} -keypass ${ANDROID_DEBUG_KEYPASS} -dname "CN=Android Debug,O=Android,C=US")
	else()
