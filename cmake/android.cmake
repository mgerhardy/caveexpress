...
if (NOT ANDROID_DEBUG_KEYSTORE)
	...
	if (KEYTOOL)
		...
		execute_process(COMMAND ${KEYTOOL} RESULT_VARIABLE exitcode -genkeypair ${KEYTOOL_FLAGS} -keystore $ENV{HOME}/.android/debug.keystore -storepass ${ANDROID_DEBUG_STOREPASS} -alias ${ANDROID_DEBUG_ALIAS} -keypass ${ANDROID_DEBUG_KEYPASS} -dname "CN=Android Debug,O=Android,C=US" )
