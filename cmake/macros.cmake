...
macro(cp_osx_add_target_properties TARGET VERSION VERSION_CODE)
	...
	if (IOS)
		...
		message(STATUS "Set ios parameters")
	endif()
...
macro(cp_add_executable)
	...
	if (IOS)
		set(RESULTS "")
		cp_ios_get_provisioning_profiles("${XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY}" "${IOS_PROVISIONG_PROFILES_DIR}" RESULTS)
		if (NOT RESULTS)
			message(FATAL "Could not find matching provisioning profile for ${XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY} in ${IOS_PROVISIONG_PROFILES_DIR}")
		else()
