...
macro(cp_osx_add_target_properties TARGET VERSION VERSION_CODE)
	set_target_properties(${TARGET} PROPERTIES MACOSX_BUNDLE_LONG_VERSION_STRING "${VERSION}")
	set_target_properties(${TARGET} PROPERTIES MACOSX_BUNDLE_SHORT_VERSION_STRING "${VERSION_CODE}")
	set_target_properties(${TARGET} PROPERTIES MACOSX_BUNDLE_BUNDLE_VERSION "${VERSION_CODE}")
	set_target_properties(${TARGET} PROPERTIES MACOSX_BUNDLE_COPYRIGHT "CaveProductions")
	set_target_properties(${TARGET} PROPERTIES MACOSX_BUNDLE_INFO_STRING "")
