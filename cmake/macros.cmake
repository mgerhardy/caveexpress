...
macro(cp_android_prepare PROJECTNAME APPNAME VERSION VERSION_CODE)
	...
	if (RELEASE)
		if (NOT ENV{CAVEPRODUCTIONS_KEYSTORE_PASSWD})
			message(FATAL "No keystore password set")
		endif()
		if (NOT ENV{CAVEPRODUCTIONS_KEYSTORE_PATH})
			message(FATAL "No keystore path set")
		endif()
