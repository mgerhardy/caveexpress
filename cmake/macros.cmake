...
macro(cp_ios_get_provisioning_profiles PROFILE_NAME PROVISIONG_PROFILES_DIR RESULT)
	...
	set(LIST "")
	foreach(FILE ${FILES})
		message(STATUS "Looking in ${FILE} for the provisioning profile")
...
macro(cp_add_executable)
	...
	if (IOS)
		...
		if (NOT RESULTS)
			if (RELEASE)
				message(FATAL "Could not find matching provisioning profile in ${IOS_PROVISIONG_PROFILES_DIR}")
			else()
				message(STATUS "Could not find matching provisioning profile in ${IOS_PROVISIONG_PROFILES_DIR}")
			endif()
		else()
