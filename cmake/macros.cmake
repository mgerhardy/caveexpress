...
macro(cp_find LIB HEADER SUFFIX)
	...
	if (PKG_CONFIG_FOUND)
		...
		if (_${PREFIX}_FOUND)
			...
			cp_message(STATUS "CFLAGS: ${${PKG_PREFIX}_CFLAGS_OTHER}")
			cp_message(STATUS "LDFLAGS: ${${PKG_PREFIX}_LDFLAGS_OTHER}")
			cp_message(STATUS "LIBS: ${${PKG_PREFIX}_LIBRARIES}")
			cp_message(STATUS "INCLUDE: ${${PKG_PREFIX}_INCLUDE_DIRS}")
...
macro(cp_target_link_libraries)
	...
	if (LIBRARIES)
		...
		list(REVERSE LIBRARIES)
		message("LIBS for ${ColorRed}${_LINKLIBS_TARGET}${ColorReset} => ${LIBRARIES} => ${LINK_LIBS}")
	...
	if (${PREFIX}_INCLUDE_DIRS)
		...
		target_include_directories(${_LINKLIBS_TARGET} PUBLIC ${${PREFIX}_INCLUDE_DIRS})
	endif()
endmacro()
