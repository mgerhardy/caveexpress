...
macro(cp_osx_add_target_properties TARGET VERSION VERSION_CODE)
	...
	if (${CMAKE_GENERATOR} STREQUAL "Xcode")
		...
		cp_set_propertiess(${TARGET} MACOSX_BUNDLE_PRODUCT_NAME "${TARGET}")
...
macro(cp_add_executable)
	...
	configure_file(${ROOT_DIR}/contrib/installer/windows/gameexplorer.xml.in ${PROJECT_BINARY_DIR}/gameexplorer.xml)
