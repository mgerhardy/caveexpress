...
macro(cp_add_library)
	...
	if (${PREFIX}_FOUND)
		...
		add_library(${_ADDLIB_LIB} ${_ADDLIB_SRCS})
		set_target_properties(${LIB} PROPERTIES FOLDER ${_ADDLIB_LIB})
		if (_ADDLIB_CFLAGS)
			set_target_properties(${LIB} PROPERTIES COMPILE_FLAGS ${_ADDLIB_CFLAGS})
		endif()
