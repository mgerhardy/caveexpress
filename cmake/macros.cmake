...
if (${CMAKE_CXX_COMPILER_ID} MATCHES "GNU")
	set(CP_GCC 1)
	set(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS} -std=c++11 -fno-rtti -fno-exceptions" CACHE STRING "C++ compiler flags" FORCE)
...
macro(cp_android_prepare PROJECTNAME APPNAME VERSION VERSION_CODE)
	...
	set(FINAL_APK_NAME final-${APPNAME}-${ANT_TARGET}.apk)
	...
	add_custom_command(TARGET ${PROJECTNAME} POST_BUILD COMMAND ${ANDROID_ZIPALIGN} -f ${ZIPALIGN_FLAGS} 4 ${APK_NAME} ${FINAL_APK_NAME} WORKING_DIRECTORY ${ANDROID_BIN_ROOT}/bin/)
...
macro(cp_add_executable)
	...
	if (ANDROID)
		...
		if (LINUX AND NOT TESTS)
			...
			install(FILES ${PROJECT_BINARY_DIR}/${_EXE_TARGET}.desktop ${PROJECT_BINARY_DIR}/${_EXE_TARGET}.appdata.xml DESTINATION ${SHARE_DIR}/application)
