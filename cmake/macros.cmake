...
macro(cp_android_prepare PROJECTNAME APPNAME VERSION VERSION_CODE)
	...
	if (NOT DEBUG)
		...
		add_custom_command(TARGET ${PROJECTNAME} POST_BUILD COMMAND ${ANDROID_ZIPALIGN} -v 4 ${APPNAME}-${ANT_TARGET}-unsigned.apk ${APPNAME}-${ANT_TARGET}.apk WORKING_DIRECTORY ${ANDROID_BIN_ROOT}/bin/)
	endif()
endmacro()
