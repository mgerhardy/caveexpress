...
macro(cp_add_executable)
	...
	if (ANDROID)
		...
		if (LINUX AND NOT TESTS AND NOT STEAMLINK)
			...
			install(FILES ${PROJECT_BINARY_DIR}/${_EXE_TARGET}-editor DESTINATION ${BIN_DIR} PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ
  GROUP_EXECUTE WORLD_READ WORLD_EXECUTE)
	...
	if (NOT TESTS)
		if (PKGDATADIR)
			install(DIRECTORY ${ROOT_DIR}/${GAME_BASE_DIR}/${BASEDIR} DESTINATION ${PKGDATADIR} COMPONENT ${_EXE_TARGET})
		else()
			install(DIRECTORY ${ROOT_DIR}/${GAME_BASE_DIR}/${BASEDIR} DESTINATION ${GAMES_DIR}/${GAME_BASE_DIR} COMPONENT ${_EXE_TARGET})
		endif()
