...
macro(cp_add_library)
	set(_OPTIONS_ARGS)
	set(_ONE_VALUE_ARGS LIB CFLAGS DEFINES LINKERFLAGS)
...
macro(cp_target_link_libraries)
	...
	if (DEFINITIONS)
		cp_unique("${DEFINITIONS}" ${TARGET}_DEFINITIONS)
		cp_message("DEFINITIONS for ${_LINKLIBS_TARGET}: ${${TARGET}_DEFINITIONS}")
		var_global(${TARGET}_DEFINITIONS)
		set_target_properties(${_LINKLIBS_TARGET} PROPERTIES COMPILE_DEFINITIONS "${${TARGET}_DEFINITIONS}")
	endif()
