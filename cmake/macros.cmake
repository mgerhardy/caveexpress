...
macro(cp_target_link_libraries)
	...
	endforeach()
	if (LINKERFLAGS)
		string(REPLACE ";" " " _TMP_STR "${LINKERFLAGS}")
		message("LDFLAGS for ${_LINKLIBS_TARGET}: ${_TMP_STR}")
		set_target_properties(${_LINKLIBS_TARGET} PROPERTIES LINK_FLAGS "${_TMP_STR}")
	endif()
	if (COMPILERFLAGS)
		string(REPLACE ";" " " _TMP_STR "${COMPILERFLAGS}")
		message("CFLAGS for ${_LINKLIBS_TARGET}: ${_TMP_STR}")
		set_target_properties(${_LINKLIBS_TARGET} PROPERTIES COMPILE_FLAGS "${_TMP_STR}")
	endif()
