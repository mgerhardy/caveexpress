...
macro(cp_add_executable)
	...
	file(GLOB_RECURSE TARGET_ASSETS ${ROOT_DIR} ${ROOT_DIR}/base/${_EXE_TARGET}/*)
	if (_EXE_ASSETS)
	...
	if (ANDROID)
		...
		if (WINDOWED)
			...
			elseif (DARWIN OR IOS)
				set_source_files_properties(${TARGET_ASSETS} PROPERTIES MACOSX_PACKAGE_LOCATION Resources)
