...
macro(package_global LIB)
	find_package(${LIB})
	set(VARLIST "")
	string(TOUPPER ${LIB} _UPPER)
	list(APPEND VARLIST ${_UPPER}_FOUND)
	list(APPEND VARLIST ${_UPPER}_INCLUDE_DIR)
	list(APPEND VARLIST ${_UPPER}_INCLUDE_DIRS)
	list(APPEND VARLIST ${_UPPER}_LIBRARY)
	list(APPEND VARLIST ${_UPPER}_LIBRARIES)
	var_global("${VARLIST}")
endmacro()
