...
function initMap()
	...
	map:addTile("tile-background-ice-03", 4.000000, 1.000000)
	...
	map:addTile("tile-background-ice-big-01", 5.000000, 5.000000)
	...
	map:addTile("tile-background-ice-big-01", 13.000000, 7.000000)
	...
	map:addCave("tile-cave-ice-01", 2.000000, 8.000000, "", 5000)
	map:addCave("tile-cave-ice-01", 3.000000, 1.000000, "", 5000)
	map:addCave("tile-cave-ice-01", 8.000000, 3.000000, "", 5000)
	map:addCave("tile-cave-ice-01", 12.000000, 6.000000, "", 5000)
