...
function initMap()
	...
	map:addTile("tile-rock-01", 0.000000, 0.000000)
	...
	map:addTile("tile-ground-03", 0.000000, 5.000000)
	map:addTile("tile-rock-01", 0.000000, 6.000000)
	map:addTile("tile-background-01", 1.000000, 0.000000)
	map:addTile("tile-rock-slope-right-02", 1.000000, 0.000000)
	...
	map:addTile("tile-rock-01", 1.000000, 6.000000)
	...
	map:addTile("tile-ground-01", 2.000000, 5.000000)
	map:addTile("tile-rock-01", 2.000000, 6.000000)
	...
	map:addTile("tile-rock-01", 8.000000, 0.000000)
	map:addTile("tile-background-01", 8.000000, 1.000000)
	map:addTile("tile-rock-01", 8.000000, 1.000000)
	...
	map:addTile("tile-waterfall-01", 8.000000, 4.000000)
	map:addTile("tile-rock-01", 8.000000, 6.000000)
	map:addTile("liane-01", 8.600002, 2.000000)

	map:addEmitter("item-stone", 4.000000, 2.000000, 1, 0, "")

	map:addCave("tile-cave-01", 0.000000, 4.000000, "", 5000)
	map:addCave("tile-cave-02", 7.000000, 4.000000, "", 0)
	map:addGate("tile-gate-rock-01", 6.000000, 4.000000, "door1", 1.000000)
	map:addPressurePlate("tile-plate-01-idle", 3.000000, 5.000000, "door1", 700.000000, 0)

	map:setSetting("width", "9")
	...
	map:addStartPosition("5.000000", "2.000000")
end
