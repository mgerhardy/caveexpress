...
function initMap()
	...
	map:addTile("tile-ground-03", 5, 2)
	...
	map:addCave("tile-cave-01", 1, 6)
	map:addCave("tile-cave-02", 6, 7)
	map:addCave("tile-cave-01", 12, 10)
	map:addCave("tile-cave-01", 13, 4)
