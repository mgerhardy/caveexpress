...
function initMap()
	...
	map:addTile("tile-ground-ledge-ice-left-02", 0, 2)
	...
	map:addTile("tile-ground-ledge-ice-left-01", 1, 2)
	map:addTile("tile-background-ice-07", 1, 3)
	map:addTile("tile-background-ice-01", 1, 4)
	map:addTile("tile-background-ice-cave-art-01", 1, 5)
	map:addTile("tile-background-ice-01", 1, 6)
	map:addTile("tile-background-ice-02", 1, 7)
	map:addTile("tile-background-ice-07", 1, 8)
	map:addTile("tile-background-ice-07", 2, 0)
	map:addTile("tile-background-ice-window-02", 2, 1)
	map:addTile("tile-ground-ledge-ice-right-01", 2, 2)
	...
	map:addCave("tile-cave-ice-01", 1, 1, "none", 1000)
	map:addCave("tile-cave-ice-02", 11, 7, "none", 2000)
