...
function initMap()
	...
	map:addTile("tile-ground-ledge-left-02", 10, 2)
	...
	map:addTile("tile-ground-ledge-left-01", 11, 2)
	...
	map:addTile("tile-rock-slope-left-02", 12, 4)
	...
	map:addCave("tile-cave-01", 1, 1, "", 5000)
	map:addCave("tile-cave-02", 7, 4, "", 5000)
