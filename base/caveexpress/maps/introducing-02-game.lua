...
function initMap()
	...
	map:addTile("tile-rock-slope-right-02", 0, 1)
	...
	map:addTile("tile-ground-01", 1, 5)
	...
	map:addTile("tile-ground-01", 3, 5)
	map:addTile("tile-rock-03", 3, 6)
	map:addTile("tile-rock-big-01", 3, 7)
	map:addTile("tile-rock-big-01", 3, 9)
	...
	map:addTile("tile-ground-02", 8, 5)
	...
	map:setSetting("waterheight", "5.6")
